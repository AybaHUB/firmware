...
/* Handle for UART */
static hal_uart_handle_t hUSART1_uart;
...
hal_uart_handle_t *mx_usart1_cfg1_hal_uart_init(void)
{
  hal_uart_config_t uart_config;

  /* Basic configuration */
  if (HAL_UART_Init(&hUSART1_uart, HAL_UART1) != HAL_OK)
  {
    return NULL;
  }
  ...
  if (HAL_RCC_USART1_SetKernelClkSource(HAL_RCC_USART1_CLK_SOURCE_PCLK2) != HAL_OK)
  {
    return NULL;
  }
...
void mx_usart1_cfg1_hal_uart_deinit(void)
{
  (void)HAL_UART_DeInit(&hUSART1_uart);
