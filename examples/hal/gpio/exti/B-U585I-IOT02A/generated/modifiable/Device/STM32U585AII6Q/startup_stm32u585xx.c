/**
  ...
  * @brief   Startup File for STM32U585xx Device
  ******************************************************************************
  * @attention
  *
...
void TIM1_UP_IRQHandler(void) __attribute__((weak, alias("Default_IRQHandler")));
void TIM1_TRG_COM_IRQHandler(void) __attribute__((weak, alias("Default_IRQHandler")));
...
void TIM8_BRK_IRQHandler(void) __attribute__((weak, alias("Default_IRQHandler")));
void TIM8_UP_IRQHandler(void) __attribute__((weak, alias("Default_IRQHandler")));
void TIM8_TRG_COM_IRQHandler(void) __attribute__((weak, alias("Default_IRQHandler")));
...
void ADF1_IRQHandler(void) __attribute__((weak, alias("Default_IRQHandler")));
