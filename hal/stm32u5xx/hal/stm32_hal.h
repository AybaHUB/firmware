...
#if defined(USE_HAL_FLASH_OB_MODULE) && (USE_HAL_FLASH_OB_MODULE == 1)
#include "stm32u5xx_hal_flash_ob.h"
#endif /* USE_HAL_FLASH_OB_MODULE == 1 */
...
#if defined(USE_HAL_IRDA_MODULE) && (USE_HAL_IRDA_MODULE == 1)
#include "stm32u5xx_hal_irda.h"
#endif /* USE_HAL_IRDA_MODULE == 1 */
