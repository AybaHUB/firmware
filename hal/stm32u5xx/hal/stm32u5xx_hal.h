...
/**
  * @brief STM32U5xx HAL driver version
   */
#define HAL_VERSION_MAIN   (0x02U) /*!< HAL driver version bitfield [31:24]: main version */
#define HAL_VERSION_SUB1   (0x00U) /*!< HAL driver version bitfield [23:16]: sub1 version */
#define HAL_VERSION_SUB2   (0x00U) /*!< HAL driver version bitfield [15:8]:  sub2 version */
#define HAL_VERSION_RC     (0x00U) /*!< HAL driver version bitfield [7:0]:   release candidate */
...
extern uint32_t                 uwTickPrio; /*!< HAL tick interruption priority */
